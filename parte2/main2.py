...
def ransac_procrustes(pts_A, pts_B, threshold=0.05, max_iter=2000, min_samples=6):
...
def main():
    ...
    for rgb_file, depth_file in zip(rgb_files, depth_files):
        ...
        # Calcular transformação inversa (de curr para ref)
        R_inv = R.T
        T_inv = -R.T @ T
        
        # Salvar
        savemat(os.path.join(output_dir, f'transform_{frame_num}.mat'), {'R': R_inv, 'T': T_inv})
